...
void print_help() {
    printf("Twitch Chat Reader - Terminal Edition\n");
    printf("======================================\n\n");
    printf("This program connects to Twitch IRC and displays chat messages in your terminal.\n\n");
    ...
    printf("  - Type messages directly in chat\n");
